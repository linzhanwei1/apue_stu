...
/* Nonfatal error unrelated to a system call. Error code passed as explict parameter.
...
/* Fatal error unrelated to a system call. Error code passed as explict parameter.
